  ...
  (test-begin
   (parameterize ([current-directory root]
     ...
     (check-equal?
      ...
      (list (hasheq 'source_digest (hash-file tests/prog.rkt)
...
;; Util
;; File -> String
;; Hashes the contents of the file with md5
(define (hash-file file) 
  (bytes->string/utf-8 (md5 (file->string file))))
